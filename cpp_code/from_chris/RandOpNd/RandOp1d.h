...
// RandOp1d
//
// This operator initializes the values of a GridFunction1d instance
...
class RandOp1d
{
	...
	RandOp1d()
    {
	    ...
	    seed = RandomGridFunction1dOp_DEFAULT_SEED;
    ...
    virtual void randomize(GridFunction1d& v)
    {
        long i;
    ...
    virtual void randomize(DoubleVector1d& v)
    {
        long i;
        double* valuesPtr = v.getDataPointer();
        for(i = 0; i < v.getDimension(); i++)
